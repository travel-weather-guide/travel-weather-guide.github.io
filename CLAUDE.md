...
| 데이터 | 색상 | Tailwind / HEX |
|--------|------|----------------|
| 최고기온 | 빨강 | `text-rose-400` / `#fb7185` |
| 최저기온 | 진회색 | `text-gray-400~500` / `#6b7280` |
| 강수량 | 하늘색 | `text-sky-500` / `#0ea5e9` |
| 습도 | 틸 | `text-teal-500` |
| 차트 최고기온 라인 | 빨강 | `#ef4444` |
| 차트 최저기온 라인 | 진회색 | `#6b7280` |
| 캘린더 배경 (더움 25°+) | 연빨강 | `bg-[#fff0f0]` |
...
| Rating | 라벨 | 색상 |
|--------|------|------|
| 5 | 최적 | `bg-green-100 text-green-700` |
| 4 | 좋음 | `bg-sky-100 text-sky-700` |
| 3 | 보통 | `bg-yellow-100 text-yellow-700` |
| 2 | 비추 | `bg-orange-100 text-orange-700` |
| 1 | 부적합 | `bg-red-100 text-red-700` |
...
### 캘린더 (일별)
- 기본 탭 (월별 개요보다 우선)
- 범례 줄 우측에 rating 뱃지 + 한줄 코멘트 인라인 배치
- 한줄 코멘트: 여행 블로거 말투 ("벚꽃 만개, 일본 여행의 최고 시기")
- 기계적 수치 나열 금지 ("선선한 날씨(14°C), 강수량 166mm" ✗)

### 코멘트 작성 규칙
- 지역 특성 반영 (벚꽃, 축제, 연무, 몬순, 폐업 등)
- 한 줄, 30자 내외
- `scripts/generate-recommendations.py`의 `COMMENTS` dict에서 관리
